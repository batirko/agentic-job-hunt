...
# agentic-job-hunt batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
agentic-job-hunt batch runner — process job offers in batch via claude -p workers
...
main() {
  ...
  echo "=== agentic-job-hunt batch runner ==="
