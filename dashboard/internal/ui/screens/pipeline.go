...
import (
	...
	"github.com/batirko/agentic-job-hunt/dashboard/internal/data"
	"github.com/batirko/agentic-job-hunt/dashboard/internal/model"
	"github.com/batirko/agentic-job-hunt/dashboard/internal/theme"
)
...
var statusOptions = []string{"Evaluated", "Applied", "Responded", "Interview", "Offer", "Rejected", "Discarded", "Ignored", "SKIP"}

// statusGroupOrder defines display order for grouped view.
var statusGroupOrder = []string{"interview", "offer", "responded", "applied", "evaluated", "skip", "rejected", "discarded", "ignored"}
