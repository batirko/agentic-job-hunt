...
4. **Generate message** using a 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: Candidate's top quantifiable achievement demonstrating they have solved similar problems.
...
5. **Versions**:
   - EN (default)
   - Other languages only if the company/role explicitly requires it.
